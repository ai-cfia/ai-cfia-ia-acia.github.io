...
![Un bureau faiblement éclairé avec des postes de travail vides](./img/3.png)
...
![Gros plan d’un sablier avec le ruissellement de sable](./img/4.png)
...
![Une tirelire brisée avec un bandage](./img/5.png)
...
![Boîte de Petri éclairée avec des graines sur une plate-forme](./img/6.png)
...
d’intensité pour la classification des semences](./img/7.png) *Image
...
semences](./img/8.png) *Précision du modèle de >95%*
...
microscope numérique TAGARNO](./img/9.png) *Source d'image: TAGARNO microscope*
...
![Vue agrandie de deux graines de Bromus secalinus (25x)](./img/10.png) *Niveau
...
variables](./img/11.png) *Niveau de grossissement: 8 semences/image, Brassica
Junsea*
...
grossissements de 5x, 10x, 20x et toutes les graines](./img/12.png) *Performance
du modèle*
...
![ ](./img/13.png) *Connecter les idées*
