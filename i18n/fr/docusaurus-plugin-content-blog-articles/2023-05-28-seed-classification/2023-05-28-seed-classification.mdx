...
description: "L'intelligence artificielle (IA) révolutionne le tri des semences dans l'agriculture. Cet article traite des méthodes avancées développées par l'ACIA qui utilisent la vision par ordinateur pour identifier et classer automatiquement les semences avec une grande précision. Avec des projets concrets et l'application SeedID, le laboratoire vise à simplifier et à améliorer le contrôle qualité des semences, tout en invitant à une collaboration ouverte pour faire progresser ces technologies."
---

L'intelligence artificielle (IA) révolutionne le tri des semences dans
l'agriculture. Cet article traite des méthodes avancées développées par l'ACIA
qui utilisent la vision par ordinateur pour identifier et classer
automatiquement les semences avec une grande précision. Avec des projets
concrets et l'application SeedID, le laboratoire vise à simplifier et à
améliorer le contrôle qualité des semences, tout en invitant à une collaboration
ouverte pour faire progresser ces technologies.
...
![ ](/img/2023-05-28-seed-classification-images/1.png)
...
![Vue rapprochée des semences avec les travailleurs les triant en
arrière-plan](/img/2023-05-28-seed-classification-images/2.png)
...
![Un bureau faiblement éclairé avec des postes de travail vides](/img/2023-05-28-seed-classification-images/3.png)
...
![Gros plan d’un sablier avec le ruissellement de sable](/img/2023-05-28-seed-classification-images/4.png)
...
![Une tirelire brisée avec un bandage](/img/2023-05-28-seed-classification-images/5.png)
...
![Boîte de Petri éclairée avec des graines sur une plate-forme](/img/2023-05-28-seed-classification-images/6.png)
...
![Grille d’images multispectrales montrant les variations de couleur et
d’intensité pour la classification des semences](/img/2023-05-28-seed-classification-images/7.png) *Image
multispectrale à 19 canaux , Carduus nutans*
...
![Graphique à barres intitulé « Accuracy » montrant les pourcentages
d'exactitude pour différentes catégories d’identification des espèces de
semences](/img/2023-05-28-seed-classification-images/8.png) *Précision du modèle de >95%*
...
![Main utilisant une spatule en métal pour manipuler les graines sous un
microscope numérique TAGARNO](/img/2023-05-28-seed-classification-images/9.png) *Source d'image: TAGARNO microscope*
...
![Vue agrandie de deux graines de Bromus secalinus (25x)](/img/2023-05-28-seed-classification-images/10.png) *Niveau
de grossissement: 2 semences/image, Bromus Secalinus*

![Huit graines de Brassica juncea mises en évidence dans des rectangles bordés
de rouge, disposées en deux rangées avec des couleurs et des motifs
variables](/img/2023-05-28-seed-classification-images/11.png) *Niveau de grossissement: 8 semences/image, Brassica
Junsea*
...
![Graphique à barres intitulé « Model Ablation Accuracy » montrant une précision
de test supérieure à 90 % pour l’identification des espèces de semences avec des
grossissements de 5x, 10x, 20x et toutes les graines](/img/2023-05-28-seed-classification-images/12.png) *Performance
du modèle*
...
![ ](/img/2023-05-28-seed-classification-images/13.png) *Connecter les idées*
