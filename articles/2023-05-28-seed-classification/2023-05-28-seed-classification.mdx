...
description: Artificial intelligence (AI) is revolutionizing seed sorting in agriculture. This article discusses advanced methods developed by the CFIA that use computer vision to automatically identify and classify seeds with high accuracy. With concrete projects and the SeedID application, the laboratory aims to simplify and improve seed quality control, and we’re also inviting open collaboration to advance these technologies.
---

Artificial intelligence (AI) is revolutionizing seed sorting in agriculture.
This article discusses advanced methods developed by the CFIA that use computer
vision to automatically identify and classify seeds with high accuracy. With
concrete projects and the SeedID application, the laboratory aims to simplify
and improve seed quality control, and we’re also inviting open collaboration to
...
![Close-up view of seeds with workers sorting them in the
background](/img/2023-05-28-seed-classification-images/2.png)
...
![Dimly lit office space with empty workstations](/img/2023-05-28-seed-classification-images/3.png)
...
![Close-up of an hourglass with sand trickling](/img/2023-05-28-seed-classification-images/4.png)
...
![Broken piggy bank with a bandage](/img/2023-05-28-seed-classification-images/5.png)
...
![Illuminated petri dish with seeds on a platform](/img/2023-05-28-seed-classification-images/6.png) *Image source:
VideometerLab*
...
![Grid of multispectral images showing color and intensity variations for seed
classification](/img/2023-05-28-seed-classification-images/7.png) *19-channel multi-spectral image, Carduus nutans*
...
![Bar graph titled ‘Accuracy’ showing percentages for different seed species
identification categories](/img/2023-05-28-seed-classification-images/8.png) *>95% model accuracy on testing
datasets*
...
![Hand using a metal spatula to handle seeds under a TAGARNO digital
microscope](/img/2023-05-28-seed-classification-images/9.png) *Image source: TAGARNO microscope*
...
![Magnified view of two Bromus secalinus seeds (25x)](/img/2023-05-28-seed-classification-images/10.png)
*Magnification: 2 seeds/image, Bromus secalinus (25x)*

![Eight Brassica juncea seeds highlighted in red-bordered rectangles, arranged
in two rows with varying colors and patterns](/img/2023-05-28-seed-classification-images/11.png) *Magnification: 8
...
![Bar chart titled ‘Model Ablation Accuracy’ showing over 90% test accuracy for
seed species identification at magnifications of 5x, 10x, 20x, and all
seeds](/img/2023-05-28-seed-classification-images/12.png) *Model test accuracy on a seed species subset.*
...
![ ](/img/2023-05-28-seed-classification-images/13.png) *Connecting ideas*
