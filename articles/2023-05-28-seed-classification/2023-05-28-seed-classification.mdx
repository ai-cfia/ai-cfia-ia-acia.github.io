...
![Dimly lit office space with empty workstations](./img/3.png)
...
![Close-up of an hourglass with sand trickling](./img/4.png)
...
![Broken piggy bank with a bandage](./img/5.png)
...
![Illuminated petri dish with seeds on a platform](./img/6.png) *Image source:
VideometerLab*
...
classification](./img/7.png) *19-channel multi-spectral image, Carduus nutans*
...
identification categories](./img/8.png) *>95% model accuracy on testing
datasets*
...
microscope](./img/9.png) *Image source: TAGARNO microscope*
...
![Magnified view of two Bromus secalinus seeds (25x)](./img/10.png)
...
in two rows with varying colors and patterns](./img/11.png) *Magnification: 8
...
seeds](./img/12.png) *Model test accuracy on a seed species subset.*
